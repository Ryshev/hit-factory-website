...
const translations = {
  en: {
    ...
    'hero.description': 'A team of professional musicians creating an unforgettable atmosphere with authentic live sound.',
    'hero.cta': 'Book Now',
  ...
  ru: {
    ...
    'hero.description': 'Команда профессиональных музыкантов, создающая неповторимую атмосферу настоящим живым звуком.',
  ...
  uk: {
    ...
    'hero.description': 'Команда профес\u0456йних музикант\u0456в, що створює неповторну атмосферу справжн\u0456м живим звуком.',
